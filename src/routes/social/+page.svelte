	...
	const socialLinks = [
		{
			...
			icon: LinkedInIcon,
			color: '#0A66C2',
			url: 'https://www.linkedin.com/in/yuvraj-kewalramani',
		...
		},
		{
			...
			icon: GitHubIcon,
			color: '#000000',
			url: 'https://github.com/Yuvii2003',
		...
		},
		{
			...
			icon: DiscordIcon,
			color: '#5865F2',
			url: 'https://discord.com/users/yuvii02',
		...
		{#if mounted}
			...
			>
				...
				<div class="flex flex-col gap-2 sm:flex-row sm:justify-center sm:gap-3 md:gap-4">
					<Button
						size="sm"
						href="https://www.linkedin.com/in/yuvraj-kewalramani"
						target="_blank"
						rel="noopener noreferrer"
					...
					<Button
						...
						href="mailto:yuvrajkewalramani@outlook.com"
					>
						Send Email
					</Button>
				</div>
